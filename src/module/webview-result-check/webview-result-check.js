...
export default memo(() => {
  ...
  const correctOption = useMemo(() => answers.find((option) => option.isCorrect)?.value, [answers]);
              ...
              color={
                item.value === answer
                  ? correctOption === answer
                    ? '#00AD22' // Hiển thị màu xanh cho câu trả lời đúng
                    : '#DB2F2D' // Hiển thị màu đỏ cho câu trả lời sai
                  : item.value === correctOption && '#FFA500' // Hiển thị màu cam cho đáp án đúng
              }
            >
